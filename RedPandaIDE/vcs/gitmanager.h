...
public:
    ...
    bool rename(const QString& folder, const QString& oldName, const QString& newName,
                QString& output);
    ...
    QList<PGitCommitInfo> log(const QString& folder, int start, int count,
    ...
    bool renameRemote(const QString& folder, const QString& oldName, const QString& newName,
                      QString& output);
    bool addRemote(const QString& folder, const QString& name, const QString& url, QString& output);
    bool setRemoteURL(const QString& folder, const QString& name, const QString& newURL,
                      QString& output);
    ...
    bool setBranchUpstream(const QString& folder, const QString& branch, const QString& remoteName,
                           QString& output);
    ...
    bool push(const QString& folder, const QString& remoteName, const QString& branch,
              QString& output);

    bool removeConfig(const QString& folder, const QString& name, QString& output);
    bool setConfig(const QString& folder, const QString& name, const QString& value,
                   QString& output);
    ...
    bool switchToBranch(const QString& folder, const QString& branch, bool create, bool force,
                        bool merge, bool track, bool noTrack, bool forceCreation, QString& output);
    bool merge(const QString& folder, const QString& commit, bool squash, bool fastForwardOnly,
               bool noFastForward, bool noCommit, QString& output,
    ...
    bool reset(const QString& folder, const QString& commit, GitResetStrategy strategy,
               QString& output);
