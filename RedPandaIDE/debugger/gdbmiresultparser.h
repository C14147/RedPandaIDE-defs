...
{
public:
    enum class ParseValueType { Value, Object, Array, NotAssigned };
...
public:
    GDBMIResultParser();
    bool parse(const QByteArray& record, const QString& command, GDBMIResultType& type,
               ParseObject& multiValues);
