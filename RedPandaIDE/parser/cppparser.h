...
public:
    ...
    QList<PStatement> getListOfFunctions(const QString& fileName, const QString& phrase,
                                         int line) const;
    ...
    QString findFirstTemplateParamOf(const QString& fileName, const QString& phrase,
                                     const PStatement& currentScope) const;
    QString findTemplateParamOf(const QString& fileName, const QString& phrase, int index,
                                const PStatement& currentScope) const;
    PStatement findFunctionAt(const QString& fileName, int line) const;
    int findLastOperator(const QString& phrase) const;
    PStatementList
    findNamespace(const QString& name) const; // return a list of PSTATEMENTS (of the namespace)
    PStatement findStatement(const QString& fullname) const;
    PStatement findStatementOf(const QString& fileName, const QString& phrase, int line) const;
    PStatement findStatementOf(const QString& fileName, const QString& phrase,
                               const PStatement& currentScope, PStatement& parentScopeType) const;

    PStatement findStatementOf(const QString& fileName, const QStringList& expression,
                               const PStatement& currentScope) const;
    PStatement findStatementOf(const QString& fileName, const QStringList& expression,
                               int line) const;
     ...
     */
    PEvalStatement evalExpression(const QString& fileName, QStringList& expression,
                                  const PStatement& currentScope) const;
    PStatement findTypeDefinitionOf(const QString& fileName, const QString& aType,
                                    const PStatement& currentClass) const;
    PStatement findTypeDef(const PStatement& statement, const QString& fileName) const;
    ...
    QString getHeaderFileName(const QString& relativeTo, const QString& headerName,
                              bool fromNext = false) const;
    ...
    QString prettyPrintStatement(const PStatement& statement, const QString& filename,
                                 int line = -1) const;
...
private:
    bool parseFile(const QString& fileName, bool inProject, const QString& contextFilename,
    ...
    PStatement addInheritedStatement(const PStatement& derived, const PStatement& inherit,
    ...
    PStatement addChildStatement(
        ...
        const PStatement& parent, const QString& fileName,
        const QString& aType, // "Type" is already in use
        const QString& command, const QString& args, const QString& noNameArgs,
        const QString& value, int line, StatementKind kind, const StatementScope& scope,
        const StatementAccessibility& classScope,
        StatementProperties properties); // TODO: InheritanceList not supported
    PStatement addStatement(const PStatement& parent, const QString& fileName,
                            const QString& aType, // "Type" is already in use
                            const QString& command, const QString& args, const QString& noNameArgs,
    ...
    PStatement addStatement(const PStatement& parent, const QString& fileName,
                            const QString& aType, // "Type" is already in use
                            const QString& command, int argStart, int argEnd, const QString& value,
                            int line, StatementKind kind, const StatementScope& scope,
                            const StatementAccessibility& classScope,
                            StatementProperties properties);
    void addMethodParameterStatement(QStringList words, int line,
    ...
    void addSoloScopeLevel(PStatement& statement, int line,
                           bool shouldResetBlock = false); // adds new solo level
    ...
    bool checkForConcept(KeywordType& keywordType)
    {
        return keywordType == KeywordType::Concept;
    }
    ...
    bool checkForRequires(KeywordType keywordType)
    {
        return keywordType == KeywordType::Requires;
    }
    ...
    PStatementList
    doFindNamespace(const QString& name) const; // return a list of PSTATEMENTS (of the namespace)
    PStatement doFindStatement(const QString& fullname) const;
    PStatement doFindStatementOf(const QString& fileName, const QString& phrase, int line) const;
    PStatement doFindStatementOf(const QString& fileName, const QString& phrase,
                                 const PStatement& currentScope, PStatement& parentScopeType) const;
    PStatement doFindStatementOf(const QString& fileName, const QString& phrase,
                                 const PStatement& currentClass) const;

    PStatement doFindStatementOf(const QString& fileName, const QStringList& expression,
                                 const PStatement& currentScope) const;
    PStatement doFindStatementOf(const QString& fileName, const QStringList& expression,
                                 int line) const;
    ...
    QList<PStatement> doListStatements(const QString& fileName, int line,
                                       const QSet<StatementKind>& kinds) const;

    PStatement doFindTypeDefinitionOf(const QString& fileName, const QString& aType,
                                      const PStatement& currentClass) const;
    QString doFindFirstTemplateParamOf(const QString& fileName, const QString& phrase,
                                       const PStatement& currentScope) const;
    QString doFindTemplateParamOf(const QString& fileName, const QString& phrase, int index,
                                  const PStatement& currentScope) const;
    ...
    PStatement findMemberOfStatement(const QString& filename, const QString& phrase,
                                     const PStatement& scopeStatement) const;
    PStatement findMemberOfStatement(const QString& phrase, const PStatement& scopeStatement) const;
    QList<PStatement> findMembersOfStatement(const QString& phrase,
                                             const PStatement& scopeStatement) const;
    PStatement findStatementInScope(const QString& name, const QString& noNameArgs,
                                    StatementKind kind, const PStatement& scope) const;
    PStatement findStatementInScope(const QString& name, const PStatement& scope) const;
    PStatement findStatementInNamespace(const QString& name, const QString& namespaceName) const;

    //{Find statement starting from startScope}
    PStatement findStatementStartingFrom(const QString& fileName, const QString& phrase,
     ...
     * @return
     */
    PEvalStatement doEvalExpression(const QString& fileName, QStringList phraseExpression, int& pos,
                                    const PStatement& scope, const PEvalStatement& previousResult,
                                    bool freeScoped, bool expandMacros) const;

    /*  add +  / minus - */
    PEvalStatement doEvalArithmeticOperation(const QString& fileName,
                                             const QStringList& phraseExpression, int& pos,
                                             const PStatement& scope,
                                             const PEvalStatement& previousResult,
                                             bool freeScoped) const;
    /* Pointer to members .* / ->*  */
    PEvalStatement doEvalPointerToMembers(const QString& fileName,
                                          const QStringList& phraseExpression, int& pos,
                                          const PStatement& scope,
                                          const PEvalStatement& previousResult,
                                          bool freeScoped) const;
     ...
     * */
    PEvalStatement doEvalTypeCast(const QString& fileName, const QStringList& phraseExpression,
                                  int& pos, const PStatement& scope,
                                  const PEvalStatement& previousResult, bool freeScoped) const;

    PEvalStatement doEvalMemberAccess(const QString& fileName, const QStringList& phraseExpression,
                                      int& pos, const PStatement& scope,
                                      const PEvalStatement& previousResult, bool freeScoped) const;
    PEvalStatement doEvalScopeResolution(const QString& fileName,
                                         const QStringList& phraseExpression, int& pos,
                                         const PStatement& scope,
                                         const PEvalStatement& previousResult,
                                         bool freeScoped) const;
    PEvalStatement doEvalTerm(const QString& fileName, const QStringList& phraseExpression,
                              int& pos, const PStatement& scope,
                              const PEvalStatement& previousResult, bool freeScoped) const;

    bool expandMacro(QStringList& phraseExpression, int pos, PStatement macro,
    ...
    PEvalStatement doCreateEvalType(const QString& fileName, const QString& typeName,
    ...
    PEvalStatement doCreateTypedEvalVar(const QString& fileName, const QString& typeName,
                                        const PStatement& parentScope,
                                        const PStatement& baseStatement) const;

    PEvalStatement doCreateEvalVariable(const QString& fileName, const PStatement& varStatement,
                                        const QString& baseTemplateParams,
                                        const PStatement& scope) const;
    PEvalStatement doCreateEvalFunction(const QString& fileName,
                                        const PStatement& funcStatement) const;
    PEvalStatement doCreateEvalLiteral(const QString& type) const;
    void doSkipInExpression(const QStringList& expression, int& pos, const QString& startSymbol,
                            const QString& endSymbol) const;
    ...
    {
        return isIdentifier(token) && (mCppTypeKeywords.contains(token) ||
                                       !mCppKeywords.contains(token) || token == "const");
    }

    PStatement doParseEvalTypeInfo(const QString& fileName, const PStatement& scope,
    ...
    void getFullNamespace(const QString& phrase, QString& sNamespace, QString& member) const;
    QString getFullStatementName(const QString& command, const PStatement& parent) const;
    PStatement getIncompleteClass(const QString& command, const PStatement& parentScope);
    QString getScopePrefix(const PStatement& statement) const;
    StatementScope getScope();
    QString getStatementKey(const QString& sName, const QString& sType,
                            const QString& sNoNameArgs) const;
    PStatement getTypeDef(const PStatement& statement, const QString& fileName,
    ...
    void handleOperatorOverloading(const QString& sType, int operatorTokenIndex, bool isStatic,
                                   int maxIndex);
    void handleMethod(StatementKind functionKind, const QString& sType, const QString& sName,
    ...
    void inheritClassStatement(const PStatement& derived, bool isStruct, const PStatement& base,
                               StatementAccessibility access);
    PStatement doFindStatementInScope(const QString& name, const QString& noNameArgs,
                                      StatementKind kind, const PStatement& scope) const;
    ...
    void scanMethodArgs(const PStatement& functionStatement, int argStart);
    QSet<QString> parseLambdaCaptures(int index);
    QString splitPhrase(const QString& phrase, QString& sClazz, QString& sOperator,
    ...
    void parseCommandTypeAndArgs(QString& command, QString& typeSuffix, QString& args) const;
...
private:
    ...
    friend void parseFileBlocking(PCppParser parser, const QString& fileName, bool inProject,
...
class CppFileParserThread : public QThread
{
    Q_OBJECT
public:
    explicit CppFileParserThread(PCppParser parser, const QString& fileName, bool inProject,
                                 const QString& contextFilename, bool onlyIfNotParsed = false,
                                 bool updateView = true, QObject* parent = nullptr);
    ~CppFileParserThread();
...
class CppFileListParserThread : public QThread
{
    Q_OBJECT
public:
    explicit CppFileListParserThread(PCppParser parser, bool updateView = true,
...
void parseFileListNonBlocking(PCppParser parser, bool updateView = true);
